...
declare var $;
@Component({
  selector: 'app-product-electronic',
  templateUrl: './product-electronic.component.html',
  styleUrls: ['./product-electronic.component.scss']
})
export class ProductElectronicComponent implements OnInit {
  ...
  getProductByCategoryName(cPage, id) {
    let x = {
      productId: id,
      page: cPage,
      size: 12
